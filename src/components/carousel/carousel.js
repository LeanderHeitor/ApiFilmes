...
export default function CarouselComponent(){
    ...
    const getFilmes = async () => {
        await axios.get('https://api.themoviedb.org/3/movie/upcoming?api_key=cfe6a1839d4b99198be61665abad026e&language=pt-BR&page=1').then(resposta=> {
        ...
        >
            {filmes.map((item)=>(
                <div>
                    ...
                    <CarouselSubTitle>{item.release_date}</CarouselSubTitle>
                </div>
            ))}
        </Carousel>
    </ContainerCarousel>
